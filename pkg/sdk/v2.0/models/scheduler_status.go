...
// ContextValidate validates this scheduler status based on context it is used
func (m *SchedulerStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
